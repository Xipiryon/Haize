...
namespace
{
	...
	*/
	struct SharedDataLexical : public hz::parser::internal::ISharedData
	{
		virtual ~SharedDataLexical()
		{
		}
	...
	char get(SharedDataLexical& info)
	{
		char c;
	...
	char peek(SharedDataLexical& info)
	{
		if (info.stream.eof())
		{
			return 0;
...
namespace hz
{
	namespace parser
	{
		...
		void Compiler::pushSeparatorToken(internal::ISharedData* info, m::String& word)
		{
			SharedDataLexical* impl = (SharedDataLexical*)info;
		...
		void Compiler::pushToken(internal::ISharedData* info, m::String& word)
		{
			SharedDataLexical* impl = (SharedDataLexical*)info;
