...
namespace
{
	...
	*/
	struct SharedDataSyntaxic : public hz::parser::internal::ISharedData
	{
...
namespace hz
{
	namespace parser
	{
		bool Compiler::readToken(internal::ISharedData* sd, parser::Token& out, m::u32 index)
		{
		...
		bool Compiler::popToken(internal::ISharedData* sd, m::u32 count)
		{
			SharedDataSyntaxic* sds = (SharedDataSyntaxic*)sd;
		...
		bool Compiler::parseGlobal(internal::ISharedData* sd)
		{
			SharedDataSyntaxic* sds = (SharedDataSyntaxic*)sd;
			parser::Token token;
			bool ok = true;
		...
		bool Compiler::parseNamespace(internal::ISharedData* sd)
		{
			SharedDataSyntaxic* sds = (SharedDataSyntaxic*)sd;
			parser::Token token;
			bool ok = true;
		...
		bool Compiler::parseClass(internal::ISharedData* sd)
		{
			SharedDataSyntaxic* sds = (SharedDataSyntaxic*)sd;
			parser::Token token;
			bool ok = true;
		...
		bool Compiler::parseFunction(internal::ISharedData* sd)
		{
			SharedDataSyntaxic* sds = (SharedDataSyntaxic*)sd;
			parser::Token token;
			bool ok;
		...
		bool Compiler::parseExpression(internal::ISharedData* sd)
		{
			SharedDataSyntaxic* sds = (SharedDataSyntaxic*)sd;
			parser::Token token;
			bool ok = true;
