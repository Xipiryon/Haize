...
namespace
{
	...
	*/
	struct SharedDataLexical : public hz::parser::priv::SharedData
	{
...
namespace hz
{
	namespace parser
	{
		namespace priv
		{
			...
			void DefaultCompiler::pushSeparatorToken(SharedData* info, m::String& word)
			{
			...
			void DefaultCompiler::pushToken(SharedData* info, m::String& word)
			{
				SharedDataLexical* impl = (SharedDataLexical*)info;
